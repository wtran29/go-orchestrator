...
var workerCmd = &cobra.Command{
	Use:   "worker",
	Short: "Worker command to operate an Archon worker node.",
	Long: `archon worker command. 

The worker runs tasks and responds to the managers's requests about task state.`,
